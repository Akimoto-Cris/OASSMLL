                ...
                if labels[m][n] == 1:
                    ...
                    if len(max_list) <= k:
                        for l in range(len(max_list)):
                            if math.pow(local_max_coordinates[index[l]][0] - max_index[0], 2) + math.pow(
                                    local_max_coordinates[index[l]][1] - max_index[1], 2) < math.pow(128, 2):
                                coor_0 += local_max_coordinates[index[l]][0]
                                coor_1 += local_max_coordinates[index[l]][1]
                                num += 1
                        if num == 0:
                            avg_index = [256, 256]
                        else:
                        ...
                        for l in range(k):
                            if math.pow(local_max_coordinates[index[l]][0] - max_index[0], 2) + math.pow(
                                    local_max_coordinates[index[l]][0] - max_index[1], 2) < math.pow(128, 2):
                                coor_0 += local_max_coordinates[index[l]][0]
                                coor_1 += local_max_coordinates[index[l]][1]
                                num += 1
                        if num == 0:
